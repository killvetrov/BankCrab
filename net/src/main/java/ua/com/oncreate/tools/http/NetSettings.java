...
import ua.com.oncreate.tools.tasks.NetMultipartTask;
...
//						httpParams, registry);
    ...
    public HttpResponse getResponse(HttpPost httpPost, NetMultipartTask.PhotoUploadResponseHandler photoUploadResponseHandler) {
        HttpResponse response = null;
        try {
            response = (HttpResponse) getHttpClient().execute(httpPost, photoUploadResponseHandler);
        } catch (Exception e) {
        }
        return response;
    }
